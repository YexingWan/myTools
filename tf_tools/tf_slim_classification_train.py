...
tf.app.flags.DEFINE_integer(
    'number_epochs', 20, 'number of epochs')
...
tf.app.flags.DEFINE_boolean(
    ...
    'if the checkpoint save the ema weight.')
...
def main(_):
    ...
    with tf.Graph().as_default():
        ...
        dataset = load_record_classification_ILSVRC_train_dataset(FLAGS.dataset_dir)
        ...
        if FLAGS.moving_average_decay:
            ...
            # moving_average_variables = _get_variables_to_train()
