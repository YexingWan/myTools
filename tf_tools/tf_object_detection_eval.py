...
flags.DEFINE_boolean(
    ...
    'provided config.')
flags.DEFINE_boolean(
    'infer_mode', False, 'set to True if inference want to be done.')
...
def main(unused_argv):
  ...
  graph_rewriter_fn = None
  if FLAGS.crquant:
      def graph_rewriter_fn():
          g = tf.get_default_graph()
          print('>' * 10, len(g.get_operations()))
          import crquant
  ...
  # evaluator.eavluate_cr(model_fn,eval_config,FLAGS.checkpoint_dir,graph_rewriter_fn)
